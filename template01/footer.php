...
<a class="twitter-timeline" href="https://twitter.com/harnishdesign" data-chrome="noheader nofooter noborders noscrollbar transparent" data-theme="dark" data-tweet-limit="2" data-related="twitterapi,twitter" data-aria-polite="assertive" data-widget-id="347621595801608192">Tweets by @harnishdesign</a>
  ...
  fjs.parentNode.insertBefore(js, fjs);
          ...
          <div class="fb-like-box" data-href="https://www.facebook.com/Psakhmers-542542775763902" data-width="370" data-show-faces="true" data-stream="false" data-header="false" data-colorscheme="dark" data-connections="16" data-color-scheme="dark" data-border-color="#222222"></div>
        </div></div></div>
      ...
      <div class="column">
        <h3>Contact Us</h3>
        <ul>
          <li><i class="glyphicon glyphicon-map-marker"></i> #31, St.271, Phnom Penh, Cambodia</li>
          <li><i class="glyphicon glyphicon-phone-alt"></i> +855 123 456</li>
          <li><a href="#"><i class="glyphicon glyphicon-envelope"> raya@titb.biz</i></a></li>
        </ul>
      </div>
      <!-- Contact Details End-->
      <div class="clear"></div>
      <div id="powered">
        ...
        <div class="powered_text part3">
          <p>CopyRight©2016<br />
            Template By <a target="_blank" href="#">Amazon Girl</a></p>
        </div>
        <!-- Powered by Text End-->
