            ...
            <div class="box-product">
              <div class="flexslider featured_carousel">
                <ul class="slides">
						...
						while($data = mysqli_fetch_object($result)){?>
							<li>
                                <div class="slide-inner">
                                  <div class="image"><a href="product.php">
                                  	<img src="image/<?php echo $data->img; ?>" alt="<?php echo $data->pro_name; ?>" /></a></div>
                                  <div class="name">
                                      <a href="#">
                                  ...
                                  <div class="cart">
                                    <a class="btn btn-danger" href="include/cart.php?id=<?php echo $data->id; ?>">Add Cart</a>
                                  </div>
                                  <div class="clear"></div>
                                </div>
                            </li>
                  ...
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.php"><img src="image/lotto-sports-shoes-white-210x210.jpg" alt="Lotto Sports Shoes" /></a></div>
                  ...
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.php"><img src="image/iphone_1-210x210.jpg" alt="iPhone 4s" /></a></div>
                      <div class="name"><a href="product.php">iPhone 4s</a></div>
                  ...
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.php"><img src="image/apple_cinema_30-210x210.jpg" alt="Apple Cinema 30&quot;" /></a></div>
                  ...
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.php"><img src="image/sony_vaio_1-210x210.jpg" alt="Friendly Jewelry" /></a></div>
                  ...
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.php"><img src="image/Jeep-Casual-Shoes-210x210.jpg" alt="Jeep-Casual-Shoes" /></a></div>
                  ...
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.html"><img src="image/htc_touch_hd_1-210x210.jpg" alt="iPhone 5s" /></a></div>
                  ...
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.html"><img src="image/ipod_touch_1-210x210.jpg" alt="Sunglass" /></a></div>
                  ...
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.html"><img src="image/reebok-men-sports-shoes-210x210.jpg" alt="Reebok Men Sports Shoes" /></a></div>
                  ...
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.html"><img src="image/samsung_tab_1-210x210.jpg" alt="Eagle Print Top" /></a></div>
                  ...
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.html"><img src="image/nikon_d300_1-210x210.jpg" alt="Nikon D300" /></a></div>
                  ...
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.html"><img src="image/samsung_syncmaster_941bw-210x210.jpg" alt="Samsung SyncMaster 941BW" /></a></div>
            ...
            <div class="box-product">
              <div class="flexslider latest_carousel_tab">
                <ul class="slides">
                  ...
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.html"><img src="image/iphone_1-210x210.jpg" alt="iPhone 4s" /></a></div>
                  ...
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.html"><img src="image/apple_cinema_30-210x210.jpg" alt="Apple Cinema 30&quot;" /></a></div>
                  ...
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.html"><img src="image/sony_vaio_1-210x210.jpg" alt="Friendly Jewelry" /></a></div>
                  ...
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.html"><img src="image/Jeep-Casual-Shoes-210x210.jpg" alt="Jeep-Casual-Shoes" /></a></div>
                  ...
                  <li>
                    <div class="slide-inner">
                      <div class="image"><a href="product.html"><img src="image/lotto-sports-shoes-white-210x210.jpg" alt="Lotto Sports Shoes" /></a></div>
                      <div class="name"><a href="http://localhost/polishop/index.php?route=product/product&amp;product_id=43">Lotto Sports Shoes</a></div>
                      <div class="price"> $589.50 </div>
                      <div class="cart">
                        <input type="button" value="Add to Cart" class="button" />
    ...
    $("ul#tabs li").click(function() {
        ...
        <section id="carousel">
          <ul class="jcarousel-skin-opencart">
            <li><a href="#"><img src="image/brand_logo.jpg" alt="brand_logo" title="brand_logo" /></a></li>
            <li><a href="#"><img src="image/brand_logo.jpg" alt="brand_logo" title="brand_logo" /></a></li>
            <li><a href="#"><img src="image/brand_logo.jpg" alt="brand_logo" title="brand_logo" /></a></li>
            <li><a href="#"><img src="image/brand_logo.jpg" alt="brand_logo" title="brand_logo" /></a></li>
            <li><a href="#"><img src="image/brand_logo.jpg" alt="brand_logo" title="brand_logo" /></a></li>
